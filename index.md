			...
			<footer class="bg-bg-3 py-8 text-center">
				<div class="container">
					<div class="row justify-content-between">
						...
						<div class="col-12 col-lg-2 col-md-3 aos-init aos-animate" data-aos="fade-down" data-aos-delay="250">
					...
					<div class="mt-6 mb-8 border-bottom border-dark-3 aos-init aos-animate" data-aos="fade-down" data-aos-delay="400">
					</div>
					<p class="fs-5 mb-0 aos-init aos-animate" data-aos="fade-down" data-aos-delay="500">Copyright © 2025 3dcopy.space</p>
				</div>
			</footer>
	<i class="br-emoji visually-hidden" data-emoji="gesture"><img id="br-emoji" src="assets/emoji.png"></i>
		<!-- Bootstrap JS -->
		<script src="assets/bootstrap.bundle.min.js.download" data-integrity="88e7162c11208a04c36ec758824953c4aa31b0dcbf13d142dda3f8bc359ba3f9"></script>

		<!-- AOS 3.0.0-beta.6 plugin JS (Animations) -->
		<script src="assets/aos.js.download"></script>
		<!-- Startup Plugins -->		<script src="assets/plugins.min.js.download"></script>
		
		<!-- Startup JS (Custom js for all blocks) - Remove ".min" if you want to edit a JS code -->
		<script src="assets/scripts.min.js.download"></script>
